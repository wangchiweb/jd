		...
		<div id="item">
			...
			<div class="product-info">
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom"><img jqimg="{{env('APP_URL')}}/storage/{{$res['goods_img']}}" src="{{env('APP_URL')}}/storage/{{$res['goods_img']}}" /></span>
						</div>
						<!--下方的缩略图-->
						<div class="spec-scroll">
							...
							<div class="items">
								<ul>
									<li><img src="{{env('APP_URL')}}/storage/{{$res['goods_img']}}" bimg="{{env('APP_URL')}}/storage/{{$res['goods_img']}}" /></li>
									<li><img src="{{env('APP_URL')}}/storage/{{$res['goods_img']}}" bimg="{{env('APP_URL')}}/storage/{{$res['goods_img']}}" /></li>
									<li><img src="{{env('APP_URL')}}/storage/{{$res['goods_img']}}" bimg="{{env('APP_URL')}}/storage/{{$res['goods_img']}}" /></li>
									<li><img src="{{env('APP_URL')}}/storage/{{$res['goods_img']}}" bimg="{{env('APP_URL')}}/storage/{{$res['goods_img']}}" /></li>
									<li><img src="{{env('APP_URL')}}/storage/{{$res['goods_img']}}" bimg="{{env('APP_URL')}}/storage/{{$res['goods_img']}}" /></li>
					...
					<div class="product-collect">
						<a href="javascript:;" id="star"><img src="/static/index/img/_/shi_heart.png" alt=""> 收藏</a>
					</div>
				</div>
				<div class="fr itemInfo-wrap">
					...
					<div class="news">
						<span><img src="/static/index/img/_/clock.png"/>品优秒杀</span>
				...
				<div class="like-list">
					<ul class="yui3-g">
						...
						<li class="yui3-u-1-6">
							<div class="list-wrap">
								<div class="p-img">
									<img src="/static/index/img/_/itemlike05.png" />
								</div>
								<div class="attr">
									<em>DELL戴尔Ins 15MR-7528SS 15英寸 银色 笔记本</em>
								</div>
						...
						<li class="yui3-u-1-6">
							<div class="list-wrap">
								<div class="p-img">
									<img src="/static/index/img/_/itemlike06.png" />
								</div>
								<div class="attr">
									<em>DELL戴尔Ins 15MR-7528SS 15英寸 银色 笔记本</em>
								</div>
